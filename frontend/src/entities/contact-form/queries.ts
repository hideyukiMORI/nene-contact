...
import type { ContactFormListDto } from '@/entities/contact-form/api-types';
import { toContactFormList } from '@/entities/contact-form/mapper';
import type { ContactFormList } from '@/entities/contact-form/model';
