...
const ICON_PATHS = {
  ...
  image:
    '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.8"/><path d="M21 16l-5-5L5 20"/>',
  phone:
    '<path d="M6.5 3.5h3l1.4 4-2 1.4a12 12 0 0 0 4.8 4.8l1.4-2 4 1.4v3a2 2 0 0 1-2.1 2A15.5 15.5 0 0 1 4.5 5.6 2 2 0 0 1 6.5 3.5z"/>',
