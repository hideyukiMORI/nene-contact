...
/**
 * Soft-deletes a notification channel. DELETE /admin/notification-channels/{id}
 */
final readonly class DeleteNotificationChannelHandler implements RequestHandlerInterface
{
