...
/**
 * SQL-backed service-token registry, scoped to the resolved organization (ADR 0006).
 * `scopes` is stored as a comma-separated string. SQL lives only here (backend-standards).
 */
