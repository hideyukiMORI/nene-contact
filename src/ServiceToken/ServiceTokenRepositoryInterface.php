...
/**
 * Persistence for the service-token registry (#386). Every query is scoped to the
 * organization held in the request-scoped org holder (ADR 0006). The token value is never
 * persisted — only metadata + the `jti` revocation key.
 */
