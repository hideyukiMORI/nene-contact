...
/**
 * Serialises service-token registry records for the admin API (#388). The token value is
 * **never** included here — only on the issuance response, exactly once
...
final class ServiceTokenResponse
{
    ...
    /**
     * Issuance response: metadata plus the plaintext `token`, shown to the operator once and
