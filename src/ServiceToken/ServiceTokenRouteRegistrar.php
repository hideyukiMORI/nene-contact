...
/**
 * Registers service-token management routes (`/admin/service-tokens`, #388). All require
 * ManageSettings via CapabilityMiddleware, scoped to the resolved organization (ADR 0006).
 */
